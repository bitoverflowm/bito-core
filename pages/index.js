  ...
  return (
    <div className="relative bg-gradient-to-r from-yellow-300 to-pink-400">
      ...
      <header className="relative flex items-center h-screen sm:mb-12">
        <div className="absolute top-10 left-5 text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-red-600 text-4xl md:text-5xl lg:text-6xl font-bold">
          🤖 BitO
        </div>
        <div className="grid grid-cols-1 p-4">
          <div className="relative z-30 text-black font-extrabold text-4xl md:text-5xl lg:text-6xl">
            Your Virtual
          </div>
          <div className="relative z-30 text-black font-extrabold text-4xl md:text-5xl lg:text-6xl">
            <div className=""><Rotating_Text /></div>
          </div>
          <div className="text-black text-sm  md:text-lg lg:text-xl mt-2">
            You focus on the business
          </div>
          <div className="text-black text-sm  md:text-lg lg:text-xl">
            We'll take care of the rest
          </div>
          <div className="text-xl md:text-2xl lg:text-3xl underline cursor-pointer" onClick={() => handleScroll(learnMoreRef)}>
            Click to Learn More
          </div>
        </div>
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="text-xl" ref={learnMoreRef
          ...
          <div>
            <div className="text-black font-bold text-3xl md:text-5xl lg:text-5xl">
              What we offer:
            </div>
            < Information />
          </div>
          <div className="text-black font-bold text-3xl md:text-5xl lg:text-5xl mt-10">
